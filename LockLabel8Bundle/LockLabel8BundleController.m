...
#import "LockLabel8BundleController.h"
...
@implementation LockLabel8BundleController
...
{
	if (_specifiers == nil) {
		_specifiers = [self loadSpecifiersFromPlistName:@"LockLabel8Bundle" target:self];
		#if ! __has_feature(objc_arc)
		[_specifiers retain];
		#endif
	}
